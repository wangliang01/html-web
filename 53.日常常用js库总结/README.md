...
Awesome GitHub Repo 会收集整理 GitHub 上高质量、有趣的开源项目，并将他们进行归类。
...
- [Vue](https://github.com/vuejs/vue) - Vue.js 是一套用于构建用户界面的渐进式框架。
- [React](https://github.com/facebook/react) - React 是一个用于构建用户界面的 JavaScript 库。
- [Angular](https://github.com/angular/angular) - Angular 是一个用于构建用户界面的开源框架。
- [Svelte](https://github.com/sveltejs/svelte) - Svelte 是一个用于构建用户界面的编译型框架。

### 小程序框架

- [Taro](https://github.com/NervJS/taro) - Taro 是一个多端统一开发解决方案，它使用 React 作为其前端框架，支持使用 TypeScript 编写小程序。
- [UniApp](https://github.com/dcloudio/uni-app) - UniApp 是一个使用 Vue 语法开发的跨平台小程序框架。

### 微前端框架

- [qiankun](https://github.com/young-developer/qiankun) - Qiankun 是一个用于微前端的 JavaScript 库，它允许多个前端应用在浏览器中运行，并共享资源。
- [wujie](https://github.com/Tencent/wujie) - Wujie 是一个用于在浏览器中运行微前端的 JavaScript 库，它允许多个前端应用在浏览器中运行，并共享资源。
- [MicroApp](https://github.com/young-developer/micro-app) - MicroApp 是一个用于在浏览器中运行微前端的 JavaScript 库，它允许多个前端应用在浏览器中运行，并共享资源。

### 桌面端框架

- [electron](https://github.com/electron/electron) - Electron 是一个用于构建桌面应用程序的开源软件框架。
- [nwjs](https://github.com/nwjs/nw.js) - NW.js 是一个用于构建桌面应用程序的 JavaScript 框架。
- [Flutter](https://github.com/flutter/flutter) - Flutter 是 Google 官方的移动端 UI 开发框架，帮助开发者快速构建高质量的原生用户界面。

### 工程化

- [webpack](https://github.com/webpack/webpack) - Webpack 是一个用于打包 JavaScript 文件的工具。
- [vite](https://github.com/vitejs/vite) - Vite 是一个用于构建前端应用程序的快速、轻量级的开发工具。

### 服务端(Node)框架

- [Express](https://github.com/expressjs/express) - Express 是一个基于 Node.js 平台，快速、开放、极简、极9482 的 Web 开发框架。
- [NestJS](https://github.com/nestjs/nest) - Nest 是一个用于构建高效且可伸缩的服务端应用程序的渐进式 Node.js 框架。
- [Koa](https://github.com/koajs/koa) - Koa 是一个基于 Node.js 的 Web 框架，用于快速和简单地创建 Web 服务。
- [Egg](https://github.com/eggjs/egg) - Egg 是一个用于构建可扩展、高可维护性的 Node.js 应用框架。
- [Midway](https://github.com/midwayjs/midway) - Midway 是一个基于 Node.js 的云原生微服务框架。

### 全栈框架

- [NuxtJS](https://github.com/nuxt/nuxt.js) - Nuxt 是一个基于 Vue 的全栈框架，用于快速构建网站。
- [NextJS](https://github.com/zeit/next.js) - Next.js 是一个用于构建用户界面的 React 框架。

### Vue组件库

- [Element UI](https://github.com/ElemeFE/element) - Element 是一套为开发者、设计师和产品经理准备的基于 Vue 2.0 的桌面端组件库。
- [iView](https://github.com/iview/iview) - iView 是一套为开发者、设计师和产品经理准备的基于 Vue.js 的桌面端组件库。
- [Ant Design Vue] (<https://github.com/ant-design/ant-design-vue>) - Ant Design Vue 是 Ant Design 的 Vue 实现，Ant Design 是一套为开发者、设计师和产品经理准备的设计语言和组件库。
- [Vant](https://github.com/youzan/vant) - Vant 是一套轻量、可靠的移动端 Vue 组件库，由有赞前端团队开源。
- [ElementPlus](https://github.com/ElementUI/element-plus) - Element Plus 是一套为开发者、设计师和产品经理准备的基于 Vue 3.0 的桌面端组件库。
- [Vuetify](https://github.com/vuetifyjs/vuetify) - Vuetify 是一套基于 Vue 的 Material Design 组件库。
- [Arco](https://github.com/Akryum/arcod) - Arco Design Vue 是一套为开发者、设计师和产品经理准备的基于 Vue3 的桌面端组件库。
- [Native UI](https://github.com/dcloudio/native-ui) - Native UI 是一套为开发者、设计师和产品经理准备的基于 Vue3 的桌面端组件库。

### 工具类

- [lodash](https://github.com/lodash/lodash) - Lodash 是一个一致性、模块化、高性能、链式调用的 JavaScript 实用工具库。
- [bignumber.js](https://github.com/MikeMcl/bignumber.js) - BigNumber.js 是一个用于处理大数字的 JavaScript 库。
- [js-cookie](https://github.com/js-cookie/js-cookie) - JS-Cookie 是一个用于处理 HTTP cookies 的 JavaScript 库。
- [qs](https://github.com/ljharb/qs) - qs 是一个用于序列化查询字符串和反序列化查询字符串的 JavaScript 库。
- [qrcode](https://github.com/endroid/qr-code) - QR Code 是一个二维条码，用于储存数字、文本或图像等数据，并在二维码上进行解码。
- [crypto-js](https://github.com/brix/crypto-js) - CryptoJS 是一个 JavaScript 的加密库。
- [sunshine-track](https://github.com/sanxin-lin/sunshine-track) 基于 行为上报，实现了 用户行为、错误监控、页面跳转、页面白屏检测、页面性能检测等上报功能。适用于 Vue、React、Angular 等框架
- [localforage](https://github.com/localForage/localForage) - localforage 用于浏览器本地的缓存操作，并且它的操作都是异步的，这样做的好处是可以降低代码执行阻塞的风险
- [dotenv](https://github.com/motdotla/dotenv) - dotenv 是一个 Node.js 模块，用于从 .env 文件加载环境变量，并将其设置为 process.env。

### 日期处理

- [dayjs](https://github.com/iamkun/dayjs) - Day.js 是一个轻量、简单且功能强大的 JavaScript 日期库。
- [moment](https://github.com/moment/moment) - Moment.js 是一个用于解析、验证、操作和格式化日期的 JavaScript 库。
...
- [quill](https://github.com/quilljs/quill) - Quill 是一个富文本编辑器，它使用内容编辑的 API 来创建一个富文本编辑器。
- [tinymce](https://github.com/tinymce/tinymce) - TinyMCE 是一款基于 HTML5 的富文本编辑器，它使用户能够快速、轻松地创建富文本内容。
- [wangEditor](https://github.com/wangeditor-team/wangEditor) - Wangeditor 是一款基于 Vue 的富文本编辑器。
...
- [marked](https://github.com/chjj/marked) - Marked 是一个基于 JavaScript 的 Markdown 解析器。
- [highlight.js](https://github.com/isagalaev/highlight.js) - Highlight.js 是一个 JavaScript 高亮库。
- [embed] () - <embed> 元素将外部内容嵌入文档中的指定位置。此内容由外部应用程序或其他交互式内容源（如浏览器插件）提供。
- [pdfjs](https://github.com/mozilla/pdf.js/) - PDF.js、pdf.js是一款使用HTML5 Canvas安全地渲染PDF文件以及遵从网页标准的网页浏览器渲染PDF文件的JavaScript库
- [pdf-lib](https://github.com/Hopding/pdf-lib) - pdf-lib是一个用于在Node.js和浏览器中创建和修改PDF文件的库。
- [exceljs] (<https://github.com/exceljs/exceljs>) - ExcelJS是一个用于读取、写入和操作Excel文件的库。
- [luckysheet](https://github.com/dream-num/Luckysheet) - luckysheet是一个纯前端的电子表格编辑器
- [univer](https://github.com/dream-num/univer/) - univer是一个基于web的电子表格编辑器
...
- [SortableJS](https://github.com/SortableJS/Sortable) - SortableJS 是一个基于 JavaScript 的拖拽排序库，它使用 CSS3 的原生拖拽 API 实现。
- [Vuedraggable](https://github.com/SortableJS/Vuedraggable) - Vuedraggable 是一个基于 Vue 的拖拽排序组件。

### 表单验证处理

- [VeeValidate](https://github.com/baianat/vee-validate) - VeeValidate 是一个基于 Vue 的表单验证插件。
- [yup] (<https://github.com/jquense/yup>) - Yup 是一个用于构建 JavaScript 表单验证库，它使用 JavaScript 的类型系统来验证对象。

### canvas绘画

- [fabric.js](https://github.com/fabricjs/fabric.js) - Fabric.js 是一个开源的 JavaScript 库，它提供了一组用于创建和操作图像、文本、形状等元素的工具。
- [pixi.js](https://github.com/pixijs/pixijs) - Pixi.js 是一个用于构建 HTML5 2D 渲染的 JavaScript 库。
- [LogicFlow](https://github.com/didi/LogicFlow) - 专注于业务自定义的流程图编辑框架，支持实现脑图、ER图、UML、工作流等各种图编辑场景。

### 数据可视化

- [ECharts](https://github.com/apache/echarts) - ECharts 是一个基于 JavaScript 的开源可视化图表库，它提供了丰富的图表类型，如折线图、柱状图、饼图、散点图等，并且支持动态更新和交互。
- [G2](https://github.com/antvis/G2) - G2 是一个基于 Vue 的可视化图表库，它提供了丰富的图表类型，如折线图、柱状图、饼图、散点图等，并且支持动态更新和交互。
- [V-Charts](https://github.com/ElemeFE/v-charts) - V-Charts基于 Vue2.0 和 Echarts 封装的 v-charts 图表组件，只需要统一提供一种对前后端都友好的数据格式设置简单的配置项，便可轻松生成常见的图表。
- [autofit.js](https://github.com/LarryZhu-dev/autofit.js) - 浏览器自适应布局解决方案，基于flex布局，支持响应式布局，支持多终端自适应。
- [v-scale-screen](https://github.com/Alfred-Skyblue/v-scale-screen) - 基于vue的屏幕自适应解决方案，支持响应式布局，支持多终端自适应。
- [FitScreen](https://github.com/jp-liu/fit-screen) - 基于vue的屏幕自适应解决方案，支持响应式布局，支持多终端自适应。

### 地图可视化

- [Leaflet](https://github.com/Leaflet/Leaflet) - Leaflet 是一个用于在 Web 浏览器中显示地图的开源 JavaScript 库。
- [高德地图](https://lbs.amap.com/) - 高德地图

### 3D可视化

- [Three.js](https://github.com/mrdoob/three.js) - Three.js 是一个用于在 Web 浏览器中创建 3D 图形的 JavaScript 库。
- [Threebox](https://github.com/jscastro76/threebox) - Threebox 是一个基于 Three.js 的库，它提供了一组用于在 Three.js 中创建 3D 地图元素的工具。

### 文档框架

- [VitePress](https://github.com/vuejs/vitepress) - VitePress 是一个基于 Vite 的静态网站生成器，它提供了一组用于创建文档的简单、易用的工具。
- [VuePress](https://github.com/vuejs/vuepress) - VuePress 是一个基于 Vue 的静态网站生成器，它提供了一组用于创建文档的简单、易用的工具。
- [Hexo](https://github.com/hexojs/hexo) - Hexo 是一个快速、简洁且高效的博客框架。
- [Docsify](https://github.com/docsifyjs/docsify) - Docsify 是一个基于 Vue 的文档网站生成器，它提供了一个简单的、易用的文档网站生成工具。

### 测试框架

- [Vitest](https://github.com/vitest-dev/vitest) - Vitest 是一个基于 Vite 的测试框架，它提供了一组用于编写测试的简单、易用的工具。
- [Jest](https://github.com/facebook/jest) - Jest 是一个 JavaScript 测试框架，它提供了一组用于编写测试的简单、易用的工具。
...
- [puppeteer](https://github.com/GoogleChrome/puppeteer) - 浏览器自动化工具
- [cheerio](https://github.com/cheeriojs/cheerio) - 轻量级、灵活的 HTML 和 XML 解析器，用于快速、灵活地提取数据。

### 其他

- [danmu](https://github.com/imtaotao/danmu) - 弹幕库
